...
export function ForestHouseModel(props) {
  const forestHouseURL = new URL("./forestHouse.glb", import.meta.url).href;
  const { nodes, materials } = useGLTF(forestHouseURL);
  return (
    <group {...props} dispose={null}>
      <mesh
        geometry={nodes.testBoard.geometry}
        material={nodes.testBoard.material}
        position={[-184.1, 442.703, 109.918]}
        scale={[13.463, 46.913, 80.368]}
      />
      <mesh
      ...
      <mesh
        ...
        material={materials["RoofMoss.001"]}
      ...
      <mesh
        ...
        material={materials["WoodPlanks.001"]}
      ...
      <mesh
        ...
        material={materials["GrassALPHA.001"]}
      ...
      <mesh
        ...
        material={materials["WoodFence.001"]}
      ...
      <mesh
        ...
        material={materials["BigRock.001"]}
      ...
      <mesh
        ...
        material={materials["BrichTree.001"]}
        position={[-206.558, 534.739, -287.136]}
        rotation={[-Math.PI / 2, 0, 0]}
        scale={100}
      />
      <mesh
        geometry={nodes.firstTree.geometry}
        material={materials["BrichTree.001"]}
      ...
      <mesh
        ...
        material={materials["TreeLeafs.001"]}
      ...
      <mesh
        ...
        material={materials["Animals.001"]}
...
useGLTF.preload(new URL("./forestHouse.glb", import.meta.url).href);
