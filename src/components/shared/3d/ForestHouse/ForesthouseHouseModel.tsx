...
Command: npx gltfjsx@6.5.3 forestHouse.glb --types 
*/
...
//     testBoard: THREE.Mesh;
//   };
//   materials: {
//     ["Window.001"]: THREE.MeshBasicMaterial;
//     ["RoofMoss.001"]: THREE.MeshBasicMaterial;
//     ["WoodPlanks.001"]: THREE.MeshBasicMaterial;
//     ["House.001"]: THREE.MeshBasicMaterial;
//     ["GrassALPHA.001"]: THREE.MeshBasicMaterial;
//     ["WoodFence.001"]: THREE.MeshBasicMaterial;
//     ["BigRock.001"]: THREE.MeshBasicMaterial;
//     ["BrichTree.001"]: THREE.MeshBasicMaterial;
//     ["TreeLeafs.001"]: THREE.MeshBasicMaterial;
//     ["Ground.001"]: THREE.MeshBasicMaterial;
//     ["Animals.001"]: THREE.MeshBasicMaterial;
//     ["Plane.001"]: THREE.MeshBasicMaterial;
//   };
//   animations: GLTFAction[];
// };

export function ForestHouseModel(props: JSX.IntrinsicElements["group"]) {
  const forestHouseURL = new URL("./forestHouse.glb", import.meta.url).href;
  const { nodes, materials } = useGLTF(forestHouseURL);
  return (
    <group {...props} dispose={null} position={[0,-300,0]}>
      {/* <mesh
      ...
      >
        <meshStandardMaterial color={"#738671"} />
      </mesh> */}
      <mesh
